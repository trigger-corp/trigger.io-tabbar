...
public class Util {
    ...
    public static void addButton(final Context context, final String callid, JsonObject params) throws IOException {
        ...
        ForgeViewController.tabBar.addView(tab, realIndex);
    ...
    public static void removeTab(String callid) {
        ForgeViewController.tabBar.removeView(tabObjects.remove(callid));
    }

    public static void removeAllTabs() {
        ForgeViewController.tabBar.removeAllViews();
        tabObjects.clear();
    }
}
